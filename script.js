window.addEventListener('DOMContentLoaded', function() {
            ...
            var createScene = function() {
                ...
                // Kepala kucing
                var catHead = BABYLON.MeshBuilder.CreateSphere("catHead", {
                    diameter: 3
                }, scene);
                ...
                // Pupil kiri
                var leftPupil = BABYLON.MeshBuilder.CreateSphere("leftPupil", {
                    diameter: 0.3
                }, scene);
                ...
                // Pupil kanan
                var rightPupil = BABYLON.MeshBuilder.CreateSphere("rightPupil", {
                    diameter: 0.3
                }, scene);
                ...
                bodyBobKeys.push({
                    frame: animationFPS / 2,
                    value: 2.1
                }); // Lebih sedikit gerakan naik turun
                bodyBobKeys.push({
                    frame: animationFPS,
                    value: 2.0
                });
                ...
                frontLeftLegKeys.push({
                    frame: 0,
                    value: 0.4
                }); // Dikurangi dari 0.5
                frontLeftLegKeys.push({
                    frame: animationFPS / 4,
                    value: -0.4
                }); // Dikurangi dari -0.5
                frontLeftLegKeys.push({
                    frame: animationFPS / 2,
            ...
            // Panggil createScene SETELAH fungsi dideklarasikan
